...
export const Footer = () => {
    ...
    return (
        ...
        <div>
            ...
            <footer id="footer" className="bg-third text-fourth">
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        <div className="md:mt-0 md:block md:right-11 md:bottom-16 absolute right-5 bottom-1/4">
                            ...
                            <a onClick={() => window.scroll({
                                ...
                                className="inline-block rounded-full hover:bg-primary p-2 text-accent shadow transition bg-fourth sm:p-3 lg:p-4"
                            // href="#MainContent"
                            >
